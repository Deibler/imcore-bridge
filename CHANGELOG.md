...
- d44d95e: Fix the publish workflow, which did not parse. Release notes are written to a
...
- 5b7091a: Distribute through GitHub Releases instead of npm. The release tarball is what
